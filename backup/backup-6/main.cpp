...
int main(int argc, char** argv)
{
  ...
  auto o = new Container<TFloat, 3, 4, Color/*TColor*/, Color/*TChild*/>;
  o->add_child(c, Vec<TFloat, 3>{0.0, 0.0, 0.0}, Vec<TFloat, 3>{0, 0, 0}, 20, 10);
  
  constexpr uint32_t Log2 = 10;
  
  auto container = new Container<TFloat, 3, Log2, Color/*TColor*/, Bridge<TFloat, 3, Color>/*TChild*/>;
  ...
  for (int i = 0; i < 5*1000*1000; i++)
    render(rs, *container, Vec<TFloat, 3>{2500, 0, 0}, 10.0 * (1u << Log2));
