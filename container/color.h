...
public:
  ...
  {
    c.r = (TC)((c.r * factor) / 255);
    c.g = (TC)((c.g * factor) / 255);
    c.b = (TC)((c.b * factor) / 255);
    c.a = (TC)((c.a * factor) / 255);
  }

  inline void Multiply(unsigned short factor)
  {
    c.r = (TC)((c.r * factor) / 65535);
    c.g = (TC)((c.g * factor) / 65535);
    c.b = (TC)((c.b * factor) / 65535);
    c.a = (TC)((c.a * factor) / 65535);
  }
